...
const EnterDestinationModal = ({ isVisible, onClose, onSave }) => {
  ...
  const handleSave = () => {
    ...
    if (departure.trim() === '') {
      ...
      Alert.alert('Saved', 'Destination has been saved successfully!', [{ text: 'OK' }]);
    }
  };
...
export default EnterDestinationModal;
